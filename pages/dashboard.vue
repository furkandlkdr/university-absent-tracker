<template>
  <div class="py-6">
    ...
    <!-- New/Edit Term Modal -->
    <div v-if="showNewTermModal || showEditTermModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
        ...
        <div class="p-4">
          <form @submit.prevent="saveTerm" class="space-y-4">
            ...
            <div>
              ...
              <div class="space-y-6">
                <div v-for="(day, dayIndex) in days" :key="dayIndex" class="border border-gray-200 dark:border-gray-700 rounded-md p-3">
                    ...
                    <div>
                      ...
                      <div class="grid grid-cols-1 gap-2">
                        <div class="flex items-center">
                          ...
                          <input
                            v-model="termForm.schedule[dayIndex].morning1"
                            type="text"
                        ...
                        <div class="flex items-center">
                          ...
                          <input
                            v-model="termForm.schedule[dayIndex].morning2"
                            type="text"
                            class="flex-1 px-2 py-1 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm text-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                            placeholder="Ders adı"
                          />
                    ...
                    <div>
                      ...
                      <div class="grid grid-cols-1 gap-2">
                        <div class="flex items-center">
                          <span class="text-xs w-10">1.</span>
                          <input
                            v-model="termForm.schedule[dayIndex].afternoon1"
                            type="text"
                            class="flex-1 px-2 py-1 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm text-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                            placeholder="Ders adı"
                          />
                        ...
                        <div class="flex items-center">
                          <span class="text-xs w-10">2.</span>
                          <input
                            v-model="termForm.schedule[dayIndex].afternoon2"
                            type="text"
                            class="flex-1 px-2 py-1 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm text-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                            placeholder="Ders adı"
                          />
            ...
            <div v-if="termFormError" class="bg-red-100 dark:bg-red-900 border border-red-400 text-red-700 dark:text-red-300 px-4 py-2 rounded-md">
              {{ termFormError }}
            </div>
      ...
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg max-w-md w-full">
        ...
        <div class="p-4">
          <p class="mb-4 text-gray-700 dark:text-gray-300">
            <strong>{{ termToDelete?.name }}</strong> dönemini silmek istediğinizden emin misiniz? Bu işlem geri alınamaz ve tüm devamsızlık kayıtları silinecektir.
          </p>
