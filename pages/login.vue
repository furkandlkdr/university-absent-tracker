      ...
      <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <form @submit.prevent="handleLogin" class="space-y-4">
          ...
          <div class="text-right">
            <NuxtLink to="/forgot-password" class="text-sm text-blue-600 dark:text-blue-400 hover:underline">
              Şifremi unuttum
            </NuxtLink>
          </div>
        ...
        <div class="mt-6 text-center">
          <p class="text-sm text-gray-600 dark:text-gray-400">
            Hesabınız yok mu?
            <NuxtLink to="/register" class="font-medium text-blue-600 dark:text-blue-400 hover:underline">
              Kaydolun
            </NuxtLink>
          </p>
        </div>
