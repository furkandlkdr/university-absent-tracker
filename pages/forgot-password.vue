  ...
  <div class="flex flex-col items-center justify-center py-10">
    <div class="w-full max-w-md">
      <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
        ...
        <div v-if="success" class="bg-green-100 dark:bg-green-900 border border-green-400 text-green-700 dark:text-green-300 px-4 py-2 rounded-md mb-4">
        ...
        <template v-else>
          ...
          <form @submit.prevent="handleResetPassword" class="space-y-4">
            ...
            <div v-if="error" class="bg-red-100 dark:bg-red-900 border border-red-400 text-red-700 dark:text-red-300 px-4 py-2 rounded-md mt-4">
              {{ error }}
            </div>
        ...
        <div class="mt-6 text-center">
          <p class="text-sm text-gray-600 dark:text-gray-400">
            <NuxtLink to="/login" class="font-medium text-blue-600 dark:text-blue-400 hover:underline">
              Giriş sayfasına dön
            </NuxtLink>
          </p>
        </div>
