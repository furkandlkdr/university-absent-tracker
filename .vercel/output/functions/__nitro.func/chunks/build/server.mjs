...
const pwa_icons_plugin_C24GcIKjcI2zsa8A86om0L2LZjx1chWtzYxD11T7Txg = defineNuxtPlugin(() => {
  return {
    provide: {
      pwaIcons: {
        transparent: {},
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    provide("setThemeHue", (hue) => {
      currentHue.value = hue;
      (void 0).documentElement.style.setProperty("--hue", hue.toString());
    });
    provide("setColorMode", (mode) => {
...
export { useAuth as a, useRouter as b, useRoute as c, defineNuxtRouteMiddleware as d, useColorMode as e, useNuxtApp as f, useRuntimeConfig as g, nuxtLinkDefaults as h, navigateTo as n, resolveRouteObject as r, server as s, useHead as u };
