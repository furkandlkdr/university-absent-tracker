...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "89b679ad-8271-49f1-a5b2-8e0167ac0e93",
...
const _bgVuEwiaNwEygcNAcLwQF8AMh0FPgVj3Fu_W0IKv4 = (function(nitro) {
...
const plugins = [
  _bgVuEwiaNwEygcNAcLwQF8AMh0FPgVj3Fu_W0IKv4
];

const _lazy_wZTMyB = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_wZTMyB, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_wZTMyB, lazy: true, middleware: false, method: undefined }
];
